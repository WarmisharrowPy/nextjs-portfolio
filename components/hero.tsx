    ...
    <div className="pb-20 pt-36">
      ...
      <div className="relative z-10 my-20 flex justify-center">
        ...
        <TextGenerateEffect
            ...
            words="Krishna Rajan S"
          />
          <TextGenerateEffect
            className="text-center1 text-[5px] md:text-4xl lg:text-2.3xl"            
            words="Freelancer | Machine Learning Developer  | Embedded Engineer | Software Developer"
          />
