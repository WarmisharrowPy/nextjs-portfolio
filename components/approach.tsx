    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col items-center justify-center gap-4 lg:flex-row">
        <Card
          ...
          description="Analyze project requirements, gather data, and define clear objectives to design an effective solution tailored to the problem."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          description="Build, train, and optimize models or software applications using appropriate tools and technologies, ensuring scalability and accuracy."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          description="Thoroughly test solutions for performance and reliability, then deploy them while monitoring and iterating for continuous improvement."
        >
          <CanvasRevealEffect
            animationSpeed={3}
